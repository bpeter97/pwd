	...
	<style>
		#headerSection .container-fluid {
			background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
				url(<?= get_theme_mod('content_management_page_header_image', get_bloginfo('template_url').'/assets/imgs/headers/custom.jpg') ?>) repeat 0 0;
		...
		<div class="container-fluid">
			<div class="d-flex flex-row">
				<div class="col mx-auto my-auto pt-5 contact" id="headerCol">
                  ...
                  <?= get_theme_mod('custom_page_header_title', 'Custom Development'); ?>
								</span>
								<p class="pt-2"><?= get_theme_mod('custom_page_text', 'Don\'t want a website but instead want some kind of web application instead? Contact us so we can talk about your project!'); ?></p>
								<br />
